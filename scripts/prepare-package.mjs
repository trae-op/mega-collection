...
const README_CONTENT = `# @devisfuture/mega-collection

Docs and examples: https://github.com/trae-op/mega-collection#readme

Imports: @devisfuture/mega-collection, /search, /filter, /sort, /merge
`;
...
async function preparePackage() {
  ...
  await writeFile(path.join(PACKAGE_DIR, "README.md"), README_CONTENT);
}
